...
(function($) {
    ...
    jQuery(document).ready(function() {
        ...
        // Sélectionne tous les éléments de la classe .portfolio-inner et initialise MixItUp
        $(".portfolio-inner").mixItUp();

        // Filtre initialement les éléments avec la classe .default
        $(".portfolio-inner").mixItUp('filter', '.default');
